<template>
  <div>
    <v-parallax
      height="450"
      :src="require('../../assets/images/kouprey (2).jpg')"
    ></v-parallax>
    <v-container grid-list-md class="py-5">
      <v-layout wrap row>
        <v-flex xs12 md6>
          <h2 class="text-uppercase font-weight-black">
            SENTI
            <br />Bloom
          </h2>
        </v-flex>
        <v-flex xs12 md6 class="text-xs-right"
          ...
          cupiditate fuga nihil architecto veniam sit quae, dignissimos nulla
          doloribus impedit aspernatur! Officiis vitae tenetur vel porro impedit
          nostrum! Harum, impedit?</v-flex
        >
        <v-flex xs12 md12>
          <v-img
            :src="require('../../assets/images/kouprey (2).jpg')"
        ...
        <v-flex xs12 md12>
          <p>
            ...
            culpa facilis, deserunt, veniam explicabo consectetur sit doloribus,
            praesentium iste impedit ullam odio dolor quos dignissimos
            perspiciatis voluptatibus voluptas et.
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores,
            odit laudantium veritatis dolore dolorem magni eveniet doloribus
            quibusdam aspernatur iste, exercitationem quae? Molestiae inventore
            ducimus facere sit, iusto distinctio architecto!
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente
            minus cumque non quibusdam fugiat, obcaecati et deserunt aut harum?
            Deserunt dolorum ratione laborum impedit officia rem quis nobis
            dolorem placeat?
          </p>
        </v-flex>
      </v-layout>
